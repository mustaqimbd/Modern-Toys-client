        ...
        <footer
            ...
            <div className="mx-6 py-10 text-center md:text-left">
                <div className="grid-1 grid gap-10 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="flex md:flex-none flex-col items-center">
                        <h6
                            className="mb-4 lg:flex justify-center font-semibold uppercase md:justify-start">
                            Follo Us
                        </h6>
                    ...
                    <div className="flex md:flex-none flex-col items-center">
                        <div>
                            ...
                            <p className="mb-4 flex md:items-center  md:justify-start">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    fill="currentColor"
